...
const ReportePagosForm: FunctionComponent<FormComponentProps> = ({ id }) => {
  ...
  const loading = useSelector(
    (state: any) => state.reportePagosReducer.loading
  );
          ...
          <Grid container spacing={1}>
            ...
            <Grid item sm={12} xs={12} md={12}>
              <CustomSelect
                ...
                required
                register={register}
                errorsMessageField={errors.Moneda && errors.Moneda.message}
              >
            ...
            <Grid item sm={12} xs={12} md={12}>
              <CustomTextField
                ...
                errorsMessageField={errors.nMonto && errors.nMonto.message}
                formatNumber
              />
            </Grid>
            <Grid item sm={12} xs={12} md={12}>
            ...
            <Grid item sm={12} xs={12} md={12}>
              <div style={{ marginTop: 30 }}>{Parse(templateInfo)}</div>
            </Grid>
          </Grid>
        </form>
      </div>
